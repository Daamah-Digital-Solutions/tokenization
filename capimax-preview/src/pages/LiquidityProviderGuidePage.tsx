  ...
  return (
    ...
    >
      <section className="info-section">
        ...
        <p>
          It offers dedicated dashboards for investors, owners, developers, brokers, and liquidity providers,
          as well as property and investment reports and analytics, ensuring full transparency and
          verifiability of all financial and investment operations.
        </p>
        ...
        <ul>
          ...
          <li>A liquidity provider can be an individual investor, bank, or specialized investment company.</li>
        </ul>

        <h2>3. Role on the Platform</h2>
        <ul>
          <li><strong>Supporting the Annual Market:</strong> Providing liquidity to ensure investors can buy and sell tokens smoothly in the Annual Market.</li>
          <li><strong>Managing Private Markets:</strong> Enabling the liquidity provider to create a private internal market for tokenized properties and support investor transactions.</li>
          <li><strong>Market Stability:</strong> Ensuring continuous trading and minimizing price differences during investor exits.</li>
          <li><strong>Investor Confidence:</strong> Providing a reliable liquidity source that investors can rely on for buying and selling on the platform.</li>
        </ul>
        ...
        <ol>
          ...
          <li>
            ...
            <ul>
              <li>Earnings from exit fees when investors leave the Annual Market.</li>
              <li>Higher earnings when exits occur through the liquidity provider's private market.</li>
              <li>Profits also generated from resale of tokens in the Annual Market, where new investors purchase these shares.</li>
            </ul>
          </li>
          <li>
            <strong>Investment Opportunities:</strong> Access to tokenized real estate projects and the ability to monitor internal market activity.
          </li>
          <li>
        ...
        <ul>
          <li>Price differences and market fees from buy/sell transactions among investors within the supported market.</li>
          <li>Exit fees earned when investors exit the Annual Market.</li>
          <li>Private market fees: Higher fees for exits or sales via the liquidity provider's private market.</li>
          <li>Token resale: Profits when new investors purchase previously sold shares.</li>
        </ul>
        ...
        <ul>
          <li>All invested funds and earnings are protected via smart contracts, ensuring automatic execution.</li>
        ...
        <p>
          ...
          Market and private liquidity markets, ensuring smooth investor exits, price stability, and
          capital protection. Earnings are generated from:
        </p>
        <ul>
          <li>Price differences and market fees.</li>
          <li>Exit fees for investors.</li>
          <li>Higher fees via the private market.</li>
          <li>Resale of tokens and purchases by new investors.</li>
        </ul>
        <p>
